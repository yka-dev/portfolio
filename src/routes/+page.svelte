<script lang="ts">
  ...
  const contentTranslateY = $derived(mapRange(scrollProgress, 0.72, 1, 64, 0));
</script>
...
<div class="relative bg-background">
        ...
        <div class="flex min-h-screen w-full max-w-7xl flex-col">
          ...
          >
            <div class="select-none text-center]">
              ...
              >
                Yassine<br />
                <span class="text-center text-foreground font-serif text-8xl"
                  >Akhouayri</span
                >
              </SplitReveal>
            </div>
  ...
  >
    ...
    >
      ...
      >
        Hi, I'm Yassine Akhouayri. I'm 18 years old and currently living in
        Montreal, Canada. I’ve always been curious about how technology works
        and how complex systems are built, which naturally led me to
        programming.
        <div class="h-10"></div>

        I started learning to code on my own a few years ago. What began as
        simple curiosity quickly turned into something I spent more and more
        time exploring. Everything I know about programming so far has been
        self-taught through documentation, online resources, and a lot of
        experimentation.
        <div class="h-10"></div>

        Most of what I learn comes from building things. I like taking an idea
        and turning it into a real project, figuring out problems along the way
        and improving the system step by step. That process of designing,
        debugging, and refining software is what I enjoy the most.
        <div class="h-10"></div>

        In the near future, I plan to study electrical engineering to better
        understand the hardware and systems that power modern computing. I'm
        particularly interested in the relationship between software and the
        underlying technology it runs on.
        <div class="h-10"></div>

        Outside of programming, I spend a lot of time learning new technologies,
        experimenting with ideas, and working on side projects to push my skills
        further.
      </SplitReveal>
    </section>

    <section class="min-h-screen mt-100">
      <div class="mx-auto flex w-full max-w-7xl flex-col gap-4 items-center">
        <div class="flex flex-col items-center gap-5">
          ...
          >
            My work focuses on building projects that help me explore new ideas
            and improve my understanding of software systems. Most of what I
            create comes from curiosity and the desire to experiment, learn, and
          ...
          >
            <Carousel.Content class="-ms-4">
              {#each projects as project, i (i)}
                <Carousel.Item class="ps-4 md:basis-1/2 xl:basis-1/3">
                  <article
	...
	"
                  >
                    ...
                    <div class="content p-6 flex flex-col items-start gap-3">
                      <div class="text">
                        <h3 class="text-2xl font-serif text-foreground">
                          {project.title}
                        </h3>
              ...
              <div class="flex flex-col gap-8">
                <div class="flex flex-wrap items-center gap-3 pb-2">
                  <SplitReveal triggerOnScroll={true} mode="chars">
                    <h3 class="font-serif text-4xl text-foreground">
    ...
    <section class="min-h-screen mt-100">
      <div class="mx-auto flex w-full max-w-7xl flex-col gap-4">
        <div class="flex flex-col items-center gap-4">
          ...
          >
            The tools I use to build and experiment with software, from
            programming languages and frameworks to the editor and utilities
            that shape my development workflow.
          </SplitReveal>
        </div>

        <div class="flex flex-col gap-8 max-w-4xl mx-auto mt-5">
    ...
    <section class="min-h-screen mt-100">
      <div class="mx-auto flex w-full max-w-7xl flex-col gap-4">
        <div class="flex flex-col items-center gap-4">
          ...
          >
            If you want to discuss a project, collaboration, or just get in
            touch, feel free to reach out. I'm always open to interesting ideas
            and opportunities.
          </SplitReveal>
        </div>
        ...
        <div class="flex justify-center items-center gap-2 mt-5">
          <SplitReveal triggerOnScroll={true} mode="lines">
            <Button
              ...
              variant="default"
              onclick={() => {
                window.location.href = "mailto:yassine_akh@proton.me";
              }}
            >
              Contact me
            </Button>
  ...
  {#if isGalleryOpen}
    ...
    >
      ...
      >
        ...
        <div class="mt-4 text-center font-mono text-sm text-muted-foreground">
